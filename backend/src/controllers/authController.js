...
export async function verify(request, reply) {
  ...
  try {
    ...
    console.log("Verification attempt with:", { email, code }); // Debugging log
    ...
    const mailOptions = {
      ...
      text: `Hello ${user.firstName},\n\nWelcome to EduBridge! Click the link below to start learning:\n\nhttps://yourdomain.com/dashboard\n\nBest regards,\nEduBridge Team`,
      // Optionally, use HTML
      // html: `<p>Hello ${user.firstName},</p><p>Welcome to EduBridge! Click the link below to start learning:</p><p><a href="https://yourdomain.com/dashboard">Go to Dashboard</a></p><p>Best regards,<br>EduBridge Team</p>`
    };
